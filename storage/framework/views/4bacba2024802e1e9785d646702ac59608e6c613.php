            ...
            <ul class="navbar-nav" id="navbar-nav">
                ...
                <li class="nav-item">
                    <a class="nav-link menu-link" href="#sidebarLayouts" data-bs-toggle="collapse" role="button" aria-expanded="false" aria-controls="sidebarLayouts">
                        <i class="mdi mdi-view-carousel-outline"></i><?php echo app('translator')->get('translation.layouts'); ?><span class="badge badge-pill bg-danger"><?php echo app('translator')->get('translation.hot'); ?></span>
                ...
                <li class="nav-item">
                    ...
                    <div class="collapse menu-dropdown" id="sidebarPages">
                        <ul class="nav nav-sm flex-column">
                            ...
                            <li class="nav-item">
                                <a href="pages-privacy-policy" class="nav-link"><span data-key="t-privacy-policy"><?php echo app('translator')->get('translation.privacy-policy'); ?></span> <span class="badge badge-pill bg-success" data-key="t-new"><?php echo app('translator')->get('translation.new'); ?></span></a>
                            </li>
                            <li class="nav-item">
                                <a href="pages-term-conditions" class="nav-link"><span>Term & Conditions</span> <span class="badge badge-pill bg-success" data-key="t-new"><?php echo app('translator')->get('translation.new'); ?></span></a>
                            </li>
                        </ul>
                    </div>
                </li>
...
<?php /**PATH D:\Tarun\Laravel Admins\velzon_laravel\velzon_laravel_v2.0\material\Admin\resources\views/layouts/sidebar.blade.php ENDPATH**/ ?>